...
→ buyers continue across search, reviews, vendor sites and other channels
...
## 1. G2: AI chat is already a major B2B software research and shortlist channel

G2's 2026 Answer Economy research surveyed 1,076 B2B software buyers and decision-makers in March 2026.

Reported findings include:

- 51% said they start software research with an AI chatbot more often than Google.
- 71% rely on AI chatbots somewhere in the software research process.
- GenAI chatbots were the most-cited source influencing which vendors make buyer shortlists, at 54%.
- 69% said guidance from an AI chatbot led them to select a different software vendor than initially planned.
- 33% bought from a vendor they had not previously heard of.

G2's July 2026 Buyer Behavior reporting additionally says common AI uses are concentrated in evaluation: total-cost understanding, shortlist building, solution research and evaluating shortlisted vendors. It also emphasizes that humans still make the final decision.
...
## 2. Gartner: AI is used for vendor/product information, but buyers still seek human validation

Gartner reported on May 20, 2026 that a survey of 645 B2B buyers, conducted August–September 2025, found:

- 45% used GenAI in their recent purchase process, primarily to gather vendor and product information.
...
- 67% preferred a sales-rep-free experience in general, while 70% preferred a completely digital/self-service buying experience.
...
## 3. McKinsey: B2B buying remains omnichannel

McKinsey's 2026 Global B2B Pulse draws on nearly 4,000 decision-makers across 13 countries. It reports that buyers use an average of ten channels across the purchasing journey and expect consistent information when moving between channels.
...
→ identify missing comparison evidence
→ improve the real public website / proof layer
→ AI and human buyers can both inspect better evidence
→ remeasure AI shortlist movement
→ optionally connect first-party traffic / conversion data later
```
...
> "Our AI visibility score is low."
