...
export default function MethodologyPage() {
  return <MarketingShell eyebrow="調べ方" title="AIが競合を選ぶ理由を、同じ質問で確かめる。" lead="AIXは会社サイトから、買い手が比較するときの質問を作ります。その質問を同じ条件で繰り返し、競合から取り返せたかを比べます。">
    ...
    <h2>数字が変わる理由</h2>
    <p>AIの回答、検索結果、競合サイト、モデルの更新によって見え方は変わります。AIXはその時点で同じ条件にそろえた結果を表示しますが、売上や順位を保証するものではありません。</p>
