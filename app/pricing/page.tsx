...
const paid = ["1ブランド", "固定Core Prompt 50件", "Discovery Prompt 20件", "Custom Prompt 最大25件", "3 AI × 各3回 × 週次", "Visibility / Recommendation / Citation / Competitor", "Narrative / Evidence / Change Pack / 対象Prompt再測定", "AI Crawlability + 実Agent Analytics ingest", "週次メールBrief", "Executive / JSON / CSV Export", "12か月Core履歴"];
