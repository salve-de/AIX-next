  ...
  return <main>
    ...
    <section className="section section-light">
      <div className="shell split-section">
        <div className="section-copy"><p className="eyebrow">THE OUTPUT</p><h2>「AI SEO 43点」ではなく、<br />購買質問ごとの勝敗を出す。</h2><p>経営者が知りたいのは抽象的な総合点ではありません。どの質問で購入候補に入り、誰に負け、どの引用元・比較材料が判断に使われたかです。</p><ul className="check-list"><li>Recommendation / Mention / Citationを分離</li><li>無料はOpenAI・Gemini・Perplexityの生回答</li><li>有料はClaude・Grokを加えた5 AI</li><li>競合CoverageとFirst Choice</li><li>Promptを追う理由とBuyer Intent</li><li>不足する比較材料と最優先Action</li></ul><Link className="button button-dark" href="/result?sample=1">無料結果の完成形を見る <ArrowIcon /></Link></div>
