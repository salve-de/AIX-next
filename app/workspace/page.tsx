...
import { PageIntelligenceShortcut } from "@/components/page-intelligence-shortcut";
...
export default function WorkspacePage() {
  return <Suspense fallback={<main className="workspace-loading">Workspaceを読み込んでいます。</main>}><WorkspaceClientV3 /><OpportunityQueue /><BusinessOutcomeStrip /><ExportCenter /><SiteReadinessPanel /><CustomPromptLab /><PageIntelligenceShortcut /></Suspense>;
}
