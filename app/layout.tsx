...
export const metadata: Metadata = {
  ...
  description: "もう、新しい営業マンを雇う必要はありません。今のホームページはそのままでOK。社名を入れるだけでChatGPTなどのAIから自社が優先的におすすめされる専用看板を自動配備。",
  applicationName: BRAND.name,
  openGraph: { siteName: BRAND.name, type: "website", locale: "ja_JP", title: "Rovan — ChatGPTは、あなたの会社をスルーしてライバルを「おすすめ」しています。", description: "もう、新しい営業マンを雇う必要はありません。今のホームページはそのままでOK。社名を入れるだけでChatGPTなどのAIから自社が優先的におすすめされる専用看板を自動配備。", url: "/" },
