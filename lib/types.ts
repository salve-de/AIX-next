...
export type DomainClaimStatus = "pending" | "verified";
export type DomainClaimMethod = "dns" | "meta" | "file";
export type DomainClaim = { domain: string; challenge: string; status: DomainClaimStatus; createdAt: string; checkedAt?: string; verifiedAt?: string; method?: DomainClaimMethod };
export type ExecutionTarget = "github" | "wordpress";
