  ...
  return <main className="report-page">
      ...
      <div className="shell">
        ...
        <div className="instant-empower-banner">
          ...
          <div className="instant-empower-main">
            ...
            <p>自社サイトの改修ゼロ。新しい営業マンを雇うことなく、ChatGPTなどの生成AIから優先推薦されやすい環境を整える専用台帳を開設できます。</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="report-watch" id="watch-plan">
      <div className="shell report-watch-inner">
        <div>
          <p className="overline">【ステップ 3】定期モニタリング機能（14日間無料トライアル）</p>
