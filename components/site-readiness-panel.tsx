...
const sampleReadiness: SiteReadiness = { checkedAt: "2026-09-02T00:00:00.000Z", passCount: 6, warnCount: 3, failCount: 0, checks: [
...
export function SiteReadinessPanel() {
  const params = useSearchParams(); const sample = params.get("sample") === "1"; const token = params.get("token") || ""; const [open, setOpen] = useState(false); const [watch, setWatch] = useState<WatchRecord | null>(sample ? sampleWatch() : null); const [error, setError] = useState("");
