    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px", marginBottom: "16px" }}>
          ...
          >
            SUBJECT: <strong style={{ color: "#0f172a" }}>{brandName}</strong>
          </div>
        </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
              ...
              <strong style={{ fontSize: "0.95rem", color: "#0f172a", lineHeight: 1.4 }}>
                データ量と知名度の圧倒的な偏り<br />
                <span style={{ fontSize: "0.8rem", color: "#64748b", fontWeight: 500 }}>（図書館の本棚の占有率の差）</span>
              </strong>
            </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
              ...
              <strong style={{ fontSize: "0.95rem", color: "#0f172a", lineHeight: 1.4 }}>
                ...
                <span style={{ fontSize: "0.8rem", color: "#64748b", fontWeight: 500 }}>（「写真・デザイン」 vs 「機械専用データ」）</span>
              </strong>
            </div>
            <p style={{ fontSize: "0.84rem", color: "#475569", lineHeight: 1.65, margin: 0 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "8px", marginBottom: "8px" }}>
            ...
            <span style={{ fontSize: "0.74rem", fontWeight: 700, color: "#475569", fontFamily: "var(--font-mono, monospace)", background: "#f1f5f9", border: "1px solid #e2e8f0", padding: "2px 8px", borderRadius: "3px" }}>
              作業工数: 0分（改修ゼロ）
            </span>
          </div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", fontSize: "0.76rem" }}>
            <span style={{ background: "#f8fafc", border: "1px solid #e2e8f0", padding: "3px 8px", borderRadius: "3px", color: "#334155" }}>
        ...
        <div id="executive-summary-comparison">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
            ...
            <span style={{ fontSize: "0.74rem", color: "#64748b", fontFamily: "var(--font-mono, monospace)" }}>
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "8px" }}>
                <span style={{ color: "#dc2626", fontWeight: 700, fontSize: "0.78rem", fontFamily: "var(--font-mono, monospace)", background: "#fef2f2", border: "1px solid #fee2e2", padding: "2px 6px", borderRadius: "3px" }}>[ BEFORE / 導入前 ]</span>
                <span style={{ color: "#64748b", fontSize: "0.74rem" }}>（AI推薦順位: {rank}位）</span>
              </div>
              <ul style={{ margin: 0, paddingLeft: "18px", fontSize: "0.82rem", color: "#64748b", lineHeight: 1.65 }}>
                <li>AIは「本棚にデータがない会社」と判定し、知名度だけで大手を推奨</li>
                <li>「確定条件」が分からないため、AIが誤案内を恐れて自社を除外</li>
                <li>対策方法が分からず、ブログ更新やサイト改修に手を取られる（または放置）</li>
                <li><strong style={{ color: "#991b1b" }}>結果: 地域で家や土地を売りたい顧客が、AI経由で大手に丸ごと流出</strong></li>
              </ul>
            </div>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "8px" }}>
                <span style={{ color: "#16a34a", fontWeight: 700, fontSize: "0.78rem", fontFamily: "var(--font-mono, monospace)", background: "#f0fdf4", border: "1px solid #bbf7d0", padding: "2px 6px", borderRadius: "3px" }}>[ AFTER / 導入後 ]</span>
                <span style={{ color: "#64748b", fontSize: "0.74rem" }}>（公式推薦パス常駐配備）</span>
              </div>
              <ul style={{ margin: 0, paddingLeft: "18px", fontSize: "0.82rem", color: "#334155", lineHeight: 1.65 }}>
                ...
                <li><strong style={{ color: "#166534" }}>結果: 「大手に断られた」「すぐに売りたい」質の高い見込み客が直接御社へ流入</strong></li>
              </ul>
            </div>
          </div>
        </div>
